...
function success(position) {
  ...
  var queryURL =
    ...
    "&lon=" +
    lon +
    "&APPID=f4d4de4a53ae884dfc78b96e481c919f";
  $.ajax({
    url: queryURL,
    method: "GET",
...
function getCurrent(city) {
  var queryURL =
    ...
    city +
    "&APPID=f4d4de4a53ae884dfc78b96e481c919f&units=imperial";
  $.ajax({
    url: queryURL,
    method: "GET",
    error: function () {
    ...
    //UV Index
    var uvURL =
      "https://api.openweathermap.org/data/2.5/uvi?appid=f4d4de4a53ae884dfc78b96e481c919f&lat=" +
      response.coord.lat +
      "&lon=" +
      response.coord.lat;
    $.ajax({
